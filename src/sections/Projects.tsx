  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container text-center">
        <p className='inline-flex uppercase font-semibold tracking-widest bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent bg-clip-text'
        >
          REAL-WORLD RESULTS
        </p>
        <h2 className='font-serif text-3xl md:text-5xl mt-6 tracking-wide'>Featured Projects</h2>
        <p className="text-center md:text-lg lg:text-lg text-white/60 mt-4 max-w-md mx-auto">See how I transformed concepts into engaging digital experiences.</p>
        {/*START Card*/}
